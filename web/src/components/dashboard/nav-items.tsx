...
const REVIEWS: DashboardNavItem = {
...
/* Both sides keep Messages, Reviews and Settings — those pages have a half for
 * each role rather than belonging to one. */
export const DASHBOARD_NAV: Record<DashboardView, DashboardNavItem[]> = {
  customer: [OVERVIEW, SAVED, MESSAGES, REVIEWS, SETTINGS],
  advertiser: [OVERVIEW, LISTINGS, MESSAGES, REVIEWS, SETTINGS],
};
